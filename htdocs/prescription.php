        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="container" style="margin-top:30px;">
                 <a href="newprescription.php" style="text-decoration:none;"><b><i class="lni lni-circle-plus"></i> New Prescription</b></a><br><br>
                    ...
                    <tbody>';
                               ...
                               $query="select a.patientcontact,a.medication,a.amount,a.bill from prescribetb a where userid = '$userid'";
