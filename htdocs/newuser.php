    ...
    <div>
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="setup.php" style="text-decoration:none;position:absolute;top:30px;right:50px;"><b><h3><i class="lni lni-list"></i> All Users</b></h3></a><br>
                <h4>Add User</h4><br>
                  <form method="post" action="newuser.php">
                    <input type="text" name="username" placeholder="enter username" class="form-control" style="border-radius:20px;"/><br>
                    <input type="password" name="password" placeholder="enter password" class="form-control" style="border-radius:20px;"/><br>
                    <select name="role" class="form-control" style="border-radius:20px;">
                        <option>Administrator</option>
                        <option>General Manager</option>
                        <option>Clinical Staff</option>
                    </select><br>
                    <input type="submit" name="newusersubmit" value="Add" class="btn btn-outline-info" style="border-radius:20px;"/><br>
                  </form>
                </div>
            </div>
        </div>
