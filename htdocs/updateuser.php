            ...
            <div class="col-md-9">
                ...
                <h4>Update Patient</h4><br>';
                    ...
                    while($row=mysqli_fetch_array($result)){
                        ...
                        $role = $row['role'];
                        echo ' <form method="post" action="updateuser.php?id='.$id.'">
                                <input type="text" value="'.$username.'"  name="username" placeholder="enter patient name" class="form-control" style="border-radius:20px;"/><br>
                                <input type="text" value="'.$password.'"  name="password" placeholder="enter doctor" class="form-control" style="border-radius:20px;"/><br>
                                <select value="'.$role.'"  name="role" class="form-control" style="border-radius:20px;">
                                    <option>Administrator</option>
                                    <option>General Manager</option>
                                    <option>Clinical Staff</option>
                                </select><br>
                    <input type="submit" name="updateusersubmit" value="Update" class="btn btn-outline-info" style="border-radius:20px;"/><br>
                  </form>';
                        }
                    }
                echo '
