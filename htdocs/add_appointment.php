<?php
    ...
    if(isset($_POST['newpatientsubmit'])){
        ...
        $query2="insert into appointmenttb(contact,name,doctor,schedule,payment,amount,userid)values('$contact','$name','$doctor','$schedule','$payment','$amount','$userid');";
