        ...
        <div class="row">
            <div class="col-md-3">
                <div style="width:100%;height:800px;background-color:#1D9BEE;padding-top:30px;">
                    <center><h3 style="color:white;font-weight:20px;font-size:30px;"><i class="lni lni-consulting"></i> Global Hospital</h3></center>
                    <ul>
            ...
            <div class="col-md-9">
                <div class="container" style="margin-top:30px;">
                        <a href="newuser.php" style="text-decoration:none;"><b><i class="lni lni-circle-plus"></i> Add New User</b></a><br><br>
                            ...
                            <tbody>';
                                    ...
                                    while($row=mysqli_fetch_array($result)){
                                        ...
                                        echo '<tr>
                                            ...
                                            <td>'.$password.'</td>
                                            <td>'.$role.'</td>
                                            <td><a href="updateuser.php?id='.$id.'"><i class="lni lni-pencil-alt"></i></a></td>
                                            <td><a href="deleteuser.php?id='.$id.'"><i class="lni lni-cross-circle"></i></a></td>
                                        </tr>';
                                    }
